    ...
    with out_path.open("w", newline="") as f:
        ...
        for img_path in images:
            ...
            try:
                ...
                # rescale=None (or omitted) allows Cellpose to run on original size
                # or auto-estimate size without forced upscaling.
                masks, flows, styles = model.eval(
                    img,
                    channels=[0, 0],
                    diameter=None,   
                    rescale=None,    # <- CHANGED: disabled upscaling for speed
                )
